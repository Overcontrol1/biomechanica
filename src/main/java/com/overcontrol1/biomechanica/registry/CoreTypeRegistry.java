...
public class CoreTypeRegistry {
    ...
    public static final CoreType OCEANUS = registerCoreType("oceanus", new CoreType(TranslationUtils.getCoreTypeKey("oceanus"), 0xFFFFFF));
    public static final CoreType CALOR = registerCoreType("calor", new CoreType(TranslationUtils.getCoreTypeKey("calor"), 0xFFFFFF));
    public static final CoreType IGNIS = registerCoreType("ignis", new CoreType(TranslationUtils.getCoreTypeKey("ignis"), 0xFFFFFF));
    public static final CoreType SALTU = registerCoreType("saltu", new CoreType(TranslationUtils.getCoreTypeKey("saltu"), 0xFFFFFF));
